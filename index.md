...
其实，这是看问题的轻重问题。如果你用java写个垃圾，没人会在意。但是你用它写个重负荷应用，这需要比较高超的技巧。这种技巧至少有一部分
的关键在于内存。你需要有计划的操纵gc。这种情况在AS3上也是存在的。AS3和java是非常棒的bcode语言。我10年前就跟java程序员说，不要捕获
异常，除非你确实知道在捕获什么。我对GC的认知比较浅薄，我大约知道gc有两种，能判断互相索引孤儿gc或者不能。

在这些脚本语言之外，我终于接触了一定让人头疼的语言。在我们那个年代，捆绑MFC的C++，我确实没真正的学会。也没有互联网。我直接
转向到delphi上，那个版本非常的早1.0。delphi是个纯粹的单重继承语言，而且跟win api靠的很近。我训练了自己一段时间，能掌握windows api大约
200多个。之后再看VC，这不是太大的问题。在现在这个世界，delphi几乎已经消失了。我想说的是，要合理组织自己的学习路线。

这之后，我就面对的是纯粹的c语言环境。在内存分配方面，c和c++没有太多的不同。这就像个潘多拉的盒子，一旦开启你就要永远跟它做斗争，
同时，你在封装的时候永远要避免跟它斗争。我经历很长一段时间的内存分配，释放，泄漏，排查。这个过程可能有5年多。我不是个聪明的人，
但我是个能够总结规律的人。那段时间，很长的一定时间我在纯粹的c语言环境下工作，我开始总结它们。
