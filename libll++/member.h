...
struct class_name {                                                                                                                                \
    ...
    struct Alias;                                                                                                                                  \
                                                                                                                                                   \
    template<typename A>                                                                                                                           \
    struct Alias<A, std::integral_constant<bool, ll::got_type<decltype(&A::member)>::value>> {                                                     \
    ...
    struct _has_class {                                                                                                                            \
        ...
        struct checker: std::false_type {};                                                                                                        \
                                                                                                                                                   \
        template<typename A>                                                                                                                       \
        struct checker<A, std::integral_constant<bool, std::is_class<typename ll::got_type<typename A::member>::type>::value>>: std::true_type {}; \
                                                                                                                                                   \
        static constexpr bool value = checker<T>::value;                                                                                           \
    };                                                                                                                                             \
    ...
    struct _has_union {                                                                                                                            \
        ...
        struct checker: std::false_type {};                                                                                                        \
                                                                                                                                                   \
        template<typename A>                                                                                                                       \
        struct checker<A, std::integral_constant<bool, std::is_union<typename ll::got_type<typename A::member>::type>::value>>: std::true_type {}; \
                                                                                                                                                   \
        static constexpr bool value = checker<T>::value;                                                                                           \
    };                                                                                                                                             \
    ...
    struct _has_enum {                                                                                                                             \
        ...
        struct checker: std::false_type {};                                                                                                        \
                                                                                                                                                   \
        template<typename A>                                                                                                                       \
        struct checker<A, std::integral_constant<bool, std::is_enum<typename ll::got_type<typename A::member>::type>::value>>: std::true_type {};  \
                                                                                                                                                   \
        static constexpr bool value = checker<T>::value;                                                                                           \
    };                                                                                                                                             \
